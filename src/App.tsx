      ...
      <header className="App-header">
        <Container sx={{ marginTop: '50px', marginBottom: '50px' }}>
          ...
          <Typography margin="30px">
            ...
            University, 2013). In this exhibit, we will analyze how controllers for video games have
            evolved throughout the years, as players and technologies became more developed.
            ...
            to respond to the demand by creating more complex games. The technology available to the
            developers while creating the game is an obvious factor in how complex a game can be.
            Games being more complex require more controls and natural ways to use those controls,
            which is only possible after technology evolves. Controllers become easier to hold but
            more buttons get added. We will also analyze some untraditional features that companies
            have tried on their controllers which may or may not have worked in their favor.
          </Typography>
          {DETAILS.map((d, i) => (
